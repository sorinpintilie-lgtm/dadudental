...
export default function TeamSection() {
  return (
    <section id="echipa" className="py-24 lg:py-32 bg-gradient-to-b from-slate-50 to-white relative">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-6">
            Specialiști 
            <span className="text-sky-500"> dedicați</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {team.map((member, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-lg shadow-slate-100 hover:shadow-xl hover:shadow-slate-200 transition-all duration-500">
        ...
        >
          <p className="text-slate-500 mb-8">Acreditări și certificări</p>
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale">
            {['ISO 9001', 'Colegiul Medicilor', 'European Dental', 'Quality Care'].map((cert, i) => (
              <div key={i} className="px-6 py-3 border border-slate-200 rounded-xl">
