...
export default function ServicesSection() {
  return (
    <section id="servicii" className="py-24 lg:py-32 bg-slate-800 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-gradient-to-bl from-sky-900/20 to-transparent" />
      <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-gradient-to-tr from-blue-900/20 to-transparent" />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-100 mb-6">
            ...
            <span className="text-sky-400"> sănătatea ta</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className={`h-full p-8 rounded-3xl bg-slate-700 border border-slate-600 hover:border-slate-500 transition-all duration-500 hover:shadow-xl hover:shadow-slate-900 hover:-translate-y-1`}>
                ...
                <button className="inline-flex items-center text-sm font-semibold text-slate-300 group-hover:text-sky-400 transition-colors">
                  Află mai multe
        ...
        >
          ...
          <a 
            ...
            className="inline-flex items-center px-8 py-4 bg-slate-700 text-white rounded-full font-semibold hover:bg-slate-600 transition-colors flex-shrink-0 border border-slate-600"
          >
